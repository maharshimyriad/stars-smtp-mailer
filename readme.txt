...
Your site now automatically sends a visual weekly summary of total emails sent — directly to your inbox.

Includes:

-Total emails sent to date

-Number of emails sent last week

-Percentage change in email activity

-Clean, image-based report for easy review

-Stay informed without logging in. Great for clients, teams, or email monitoring!
...
- Real-time email logs with status tags
- Built-in support for SPF, DKIM, and DMARC authentication
- Multilingual support — now in Spanish, French, Arabic, Portuguese, Russian, and German
...
== Changelog ==
= 2.2.1 =
* Added weekly email update feature.
...
= 2.2.0 =
Added multilingual support for 6 languages. It's recommended to update to benefit from expanded language accessibility and overall performance improvements.
